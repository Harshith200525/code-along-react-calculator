...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "CALCULATE":
      return { ...state, input: eval(state.input).toString(), result: eval(state.input).toString() }
    case "CLEAR":
      return initialState
    case "DELETE":
    ...
    <div className='App'>
      ...
      <div className='buttons-pad'>
        <div className='buttons'>
          <div className='g-1'>
            <button onClick={() => handleClick("AC")} style={{width: "50%"}}>AC</button>
          ...
          <div>
            ...
            <button onClick={() => handleClick("=")} style={{width: "50%"}}>=</button>
          </div>
        </div>
      </div>
    </div>
